		...
		if ($category_info) {
			...
			foreach ($results as $result) {
				...
				$data['products'][] = array(
					...
					'thumb'       => $image,
					'name'        => $result['name'],
					'category_name' => $product_cat_parent['name'],
			...
			$data['product_total'] = sprintf( $this->language->get( 'text_products_total' ), $product_total );

			if( $product_total/$limit > 1 ){
			...
			$data['oc_filter'] = $this->load->controller( 'extension/module/ocfilter' );
