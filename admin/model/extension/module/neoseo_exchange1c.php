...
class ModelExtensionModuleNeoSeoExchange1c extends NeoSeoModel
{
	...
	public function getCpriceModuleStatus()
	{
		$query = $this->db->query("SHOW TABLES LIKE '" . DB_PREFIX . "product_cprice'");
